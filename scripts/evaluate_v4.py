...
from models.video_depth_model_v4 import VideoDepthAnything
...
def evaluate(args):
    ...
    for batch_idx, batch in enumerate(tqdm(val_loader)):
        ...
        if args.model_name == 'dav2':
            ...
            pred_depths = model(pred_depths)
        infer_elapsed_time += time.perf_counter() - infer_start_time
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='trained_models/E215_video_depth_normal_epoch_1.pth', help='Path to validation checkpoint file')
    ...
    parser.add_argument('--eval_data', type=str, default='Bonn', choices=['Sintel', 'NYUv2', 'Bonn', 'VKitti', 'PointOdyssey', 'TartanAir'], help='Evaluation dataset to use')
    parser.add_argument('--max_eval_count', type=int, default=500, help='Maximum number of evaluation batches to process')
